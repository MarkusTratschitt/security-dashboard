...
import { a as clearBuildDir } from '../shared/cli.CYsm2poU.mjs';
import { l as loadKit } from '../shared/cli.DlcAx0De.mjs';
import { a as logger } from '../shared/cli.D1TCjfF5.mjs';
import { l as loadNuxtManifest, r as resolveNuxtManifest, w as writeNuxtManifest } from '../shared/cli.B5Iit5gT.mjs';
import 'node:fs';
import 'node:path';
import 'citty';
import 'consola';
...
class NuxtDevServer extends EventEmitter {
  ...
  handler;
  listener;
  async _renderLoadingScreen(res) {
    res.statusCode = 503;
...
export { _getDevServerDefaults, _getDevServerOverrides, createNuxtDevServer };
